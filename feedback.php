...
<title>SKYLINE ONLINE SERVICES || FEEDBACK </title>
...
<div class="col-lg-6">
<span class="logo">ONLINE EXAMINATION SERVICES</span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
<div class="col-md-10">
<a href="mailto:aswarnakar095@gmail.com" style="color:#000000">aswarnakar095@gmail.com</a><br /><br />
</div><div class="col-md-1"></div></div>
<p>Or you can directly submit your feedback by filling the enteries below:-</p>
<form role="form"  method="post" action="feed.php?q=feedback.php">
<div class="row">
<div class="col-md-3"><b>Name:</b><br /><br /><br /><b>Phone Number:</b><br /><br /><br /><b>Subject:</b></div>
<div class="col-md-9">
<!-- Text input-->
<div class="form-group">
  <input id="name" name="name" placeholder="Enter your name" class="form-control input-md" type="text"><br /> 
 <input id="number" name="number" placeholder="Enter your phone number" class="form-control input-md" type="numeric"><br />    
